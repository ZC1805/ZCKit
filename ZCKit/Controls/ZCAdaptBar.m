...
@property (nonatomic, assign) ZCAdaptBarPosition adaptPosition;
...
- (instancetype)initWithFrame:(CGRect)frame position:(ZCAdaptBarPosition)position {
...
- (UIView *)contentView {
    if (!_contentView) {
        _contentView = [[UIView alloc] initWithFrame:CGRectZero color:[UIColor clearColor]];
...
- (UIView *)reserveView {
    if (!_reserveView) {
        _reserveView = [[UIView alloc] initWithFrame:CGRectZero color:[UIColor clearColor]];
