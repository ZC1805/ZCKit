...
typedef NS_ENUM(NSUInteger, ZCAdaptBarPosition) {
    ZCAdaptBarPositionTop    = 0,  /**< 顶部样式 */
    ZCAdaptBarPositionBottom = 1,  /**< 底部样式 */
};
...
- (instancetype)initWithFrame:(CGRect)frame position:(ZCAdaptBarPosition)position;  /**< 指定初始化方法 */
