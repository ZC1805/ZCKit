...
- (NSArray *)arrayValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSArray class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse array obj is null");
    } else {
...
- (NSDictionary *)dictionaryValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSDictionary class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse dict obj is null");
    } else {
...
- (NSString *)stringValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSString class]]) {
        if ([(NSString *)obj isEqualToString:@"<null>"]) {
            if ([ZCGlobal isPrintLog]) NSLog(@"parse string obj is <null>");
...
- (NSNumber *)numberValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSNumber class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse number obj is null");
    } else {
...
- (NSDecimalNumber *)decimalValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSNumber class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse decimal obj is null");
    } else {
        NSAssert(0, @"parse decimal obj is invalid");
    }
    if (decvalue == nil || [decvalue equal:[NSDecimalNumber notANumber]]) {
        if ([ZCGlobal isPrintLog]) NSLog(@"parse decimal obj is invalid number");
...
- (NSString *)priceValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSString class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse price obj is null");
    } else {
...
- (long)longValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSNumber class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse long obj is null");
    } else {
...
- (float)floatValueForKey:(NSString *)key {
    ...
    if ([obj isKindOfClass:[NSNumber class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse float obj is null");
    } else {
...
- (BOOL)boolValueForKey:(NSString *)key defaultValue:(BOOL)defalut {
    ...
    if ([obj isKindOfClass:[NSNumber class]]) {
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"parse bool obj is null");
    } else {
...
- (void)injectValue:(id)value forKey:(NSString *)key allowNull:(BOOL)allowNull {
    ...
    if ([value isKindOfClass:[NSString class]]) {
        if (allowNull) {
            ...
            if ([ZCGlobal isPrintLog]) NSLog(@"inject string obj is invalid");
        }
        ...
        if ([ZCGlobal isPrintLog]) NSLog(@"inject value obj is invalid");
    }
}
